...
defined in Sec. \ref{sec:alldata} with \ref{eq:priorcov}.}
\label{fig:prior}
\end{figure}
...
\begin{equation}
\label{eq:gr}
R_{k}^{i} = \sqrt{\frac{(1-\frac{2}{I_{0}})w_{k}+\frac{2}{I_{0}}b_{k}}{w_{k}}},
\end{equation}
...
calculated to determine the duration of the burn-in period.  Convergence is 
achieved when the statistic approaches unity.  
